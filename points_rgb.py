...
def template_embed_rgb(img, pots, PN=genPN(16), isOnes=False):
...
def template_extract_rgb(img, PN):
    dimg = img.float()
    PNwid = PN.shape[0]
    # cA, (cH, cV, cD) = pywt.dwt2(img[:, :, 2], 'db2')
    # cov = cD
...
if __name__ == '__main__':
    ...
    imgpath = r'D:\BaiduNetdiskWorkspace\PycharmProject\Net\exp\sample\origin\19.jpg'
